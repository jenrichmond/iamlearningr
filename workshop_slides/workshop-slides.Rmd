...
- Go to this link INSERT LINK CLOUD SPACE
...
Step 2. Then open the get-your-data-in.Rmd file and find the grey "chunk" that has  `library(tidyverse)` in it. Add these below to load the following packages. 
