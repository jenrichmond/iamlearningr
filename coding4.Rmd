...
In this coding exercise, you will work with data from a study published in Psychological Science. You can [download the data file here](https://github.com/jenrichmond/iamlearningr/blob/master/data/4_Bastian2014.csv) or use the code below to read it straight from github. 
...
bastian <- read_csv("https://raw.githubusercontent.com/jenrichmond/iamlearningr/master/data/4_Bastian2014.csv")
```
