...
In this coding exercise, you will work with data from a study published in Psychological Science. You can [download the data file here](https://github.com/jenrichmond/iamlearningr/blob/master/data/2_Beall.csv) or use the code below to read it straight from github. 
...
beall <- read_csv("https://raw.githubusercontent.com/jenrichmond/iamlearningr/master/data/2_Beall.csv")
```
